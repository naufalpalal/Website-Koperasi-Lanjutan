				...
				<div class="md:col-span-4 pr-6 border-r border-gray-200">
					<div class="flex items-start gap-4">
						<img src="{{ asset('assets/poliwangi_icon.png') }}" alt="Poliwangi Logo"
							class="w-20 h-20 object-contain rounded-lg bg-gray-50 p-2">
						<div>
							...
							<div class="flex items-center gap-2 mb-2">
								...
								<p class="text-sm text-gray-700"><span class="font-medium text-gray-800">Dosen
										Pembimbing:</span><br />Devit Suwardiyanto, S.Si., M.T</p>
							</div>
							...
							<div class="flex items-center gap-2">
								...
								<p class="text-sm text-gray-700"><span
										class="font-medium text-gray-800">Client:</span><br />Danang Sudarso W.P.J.W, S.P.,
									M.M</p>
							</div>
						</div>
					</div>
