...
@section('content')
    <div class="max-w-4xl mx-auto mt-8 px-4">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-lg p-8">
            ...
            {{-- Form --}}
            <form action="{{ route('pengurus.anggota.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                    ...
                    <div class="md:px-6 space-y-6">
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            <div class="flex items-center gap-3 mb-4">
                                <span
                                    class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-purple-50 text-purple-600">
                                    <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" />
                                        <path d="M14 2v6h6" fill="#fff" />
                                    </svg>
                                </span>
                                <h3 class="text-lg font-bold text-gray-800">Upload Dokumen Anggota</h3>
                            </div>

                            <div class="grid grid-cols-1 gap-5">
                                {{-- Dokumen Pendaftaran --}}
                                <div>
                                    <label class="font-semibold text-gray-700">Dokumen Pendaftaran (PDF/JPG)</label>
                                    <input type="file" name="dokumen_pendaftaran" accept="application/pdf,image/*"
                                        class="mt-2 block w-full border border-gray-200 rounded-lg px-3 py-2 bg-white">
                                </div>

                                {{-- SK Tenaga Kerja --}}
                                <div>
                                    <label class="font-semibold text-gray-700">SK Tenaga Kerja (PDF/JPG)</label>
                                    <input type="file" name="sk_tenaga_kerja" accept="application/pdf,image/*"
                                        class="mt-2 block w-full border border-gray-200 rounded-lg px-3 py-2 bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <input type="hidden" name="simpanan_wajib" value="0">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="number" name="simpanan_sukarela" value="{{ old('simpanan_sukarela') }}"
