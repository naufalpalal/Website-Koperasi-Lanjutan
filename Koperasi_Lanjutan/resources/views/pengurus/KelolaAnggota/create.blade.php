                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama') }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                        ...
                        <div class="mb-4">
                            <label for="no_telepon" class="block text-sm font-medium text-gray-700">No Telepon <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="no_telepon" name="no_telepon" value="{{ old('no_telepon') }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nip" name="nip" value="{{ old('nip') }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
