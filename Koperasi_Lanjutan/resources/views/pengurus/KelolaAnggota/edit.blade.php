                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $anggota->nama) }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                        ...
                        <div class="mb-4">
                            <label for="no_telepon" class="block text-sm font-medium text-gray-700">No Telepon <span
                                    class="text-red-500">*</span></label>
                            <input type="text" id="no_telepon" name="no_telepon"
                                value="{{ old('no_telepon', $anggota->no_telepon) }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="simpanan_sukarela" class="form-control"
                                value="{{ $anggota->simpananSukarela()->latest()->value('nilai') ?? 0 }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="nip" class="block text-sm font-medium text-gray-700">NIP</label>
                            <input type="text" id="nip" name="nip" value="{{ old('nip', $anggota->nip) }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" id="tempat_lahir" name="tempat_lahir"
                                value="{{ old('tempat_lahir', $anggota->tempat_lahir) }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                value="{{ old('tanggal_lahir', $anggota->tanggal_lahir) }}" class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="alamat_rumah" name="alamat_rumah" rows="3"
                                class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                                             @error('alamat_rumah') border-red-500 @enderror">{{ old('alamat_rumah', $anggota->alamat_rumah) }}</textarea>
                            @error('alamat_rumah')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <textarea id="unit_kerja" name="unit_kerja" rows="3"
                                class="mt-1 block w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none 
                                             @error('unit_kerja') border-red-500 @enderror">{{ old('unit_kerja', $anggota->unit_kerja) }}</textarea>
                            @error('unit_kerja')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
