...
@section('content')
    ...
    <div class="container mx-auto pt-12 px-4 lg:px-10">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
            ...
            {{-- Search --}}
            <div class="mb-4">
                <form method="GET" action="{{ url()->current() }}" class="flex items-center gap-2 w-full md:w-1/2">
                    <input type="text" name="q" id="searchInput" value="{{ request('q') }}" placeholder="Cari nama anggota..." class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none" />
