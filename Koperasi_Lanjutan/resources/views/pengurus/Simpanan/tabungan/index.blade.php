        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('pengurus.tabungan.download.excel') }}"
                    class="text-green-600 hover:text-green-700 transition" title="Download Excel">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="size-7 sm:size-6">
                ...
                <form method="GET" action="{{ route('pengurus.tabungan.index') }}"
                    ...
                    <input type="text" name="search" value="{{ $search ?? '' }}" placeholder="Cari nama anggota..."
                        class="border border-gray-300 rounded-lg px-4 py-2 w-full sm:w-64 focus:ring-2 
