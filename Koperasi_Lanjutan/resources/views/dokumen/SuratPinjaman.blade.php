...
<div class="container">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td class="colon">:</td>
            <td class="value">{{ $user->jumlah_pinjaman }}</td>
        </tr>
        <tr>
    ...
    <p class="content">Menyatakan menerima ketentuan pinjaman sebagaimana tertulis ini, selanjutnya pinjaman tersebut menjadi pinjaman pribadi Saya.</p>
    ...
    <ol>
        ...
        <li>Untuk pelunasan fasilitas kredit tersebut, Saya memberikan kuasa penuh yang tidak dapat dibatalkan / dicabut kepada Bendahara KKP guna mendebet gaji / tunjangan lainnya yang selanjutnya dibayarkan sebagai angsuran bulanan / pelunasan kredit yang saya peroleh dari KKP. Apabila Saya keluar dari keanggotaan Koperasi, maka KKP berhak untuk melakukan pendebetan sebesar jumlah tunggakan yang menjadi kewajiban Saya, langsung dari gaji / benefit terakhir yang menjadi hak Saya sebagai anggota.</li>
    ...
    <p class="closing">Apabila Saya melalaikan hal-hal yang telah Saya sebutkan diatas, maka Saya bersedia dituntut sesuai dengan hukum yang berlaku.</p>

    <p class="closing">Demikian surat pernyataan dan kuasa ini Saya buat dengan sebenar-benarnya dan digunakan sebagaimana mestinya.</p>
        ...
        <table class="signature-table">
            <tr>
                <td>
                    ...
                    <div class="signature-name">(...{{ $user->nama }})<br><span class="signature-note">Pemohon</span></div>
                </td>
                <td>
                    <div class="signature-title">Mengetahui<br>Bendahara Koperasi</div>
                    <div class="signature-name">({{ $identitas->nama_bendahara_koperasi ?? 'Erlina Kusumawati, S.ST.' }})</div>
                </td>
                <td>
                    <div class="signature-title">Disetujui oleh<br>Ketua Koperasi</div>
                    <div class="signature-name">({{ $identitas->nama_ketua_koperasi ?? 'Dr. Danang S.W.P.J. Widakdo, S.P., M.M' }})</div>
                </td>
            </tr>
        </table>
    </div>
