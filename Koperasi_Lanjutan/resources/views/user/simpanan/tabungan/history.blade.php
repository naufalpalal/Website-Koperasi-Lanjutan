...
<div class="container mx-auto px-4 sm:px-6 py-10">
    <div class="bg-white shadow-lg rounded-xl p-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6">
            <h2 class="text-xl sm:text-2xl font-semibold text-gray-700">Riwayat Tabungan Lengkap</h2>
        ...
        {{-- Filter Data --}}
        <form method="GET" 
              class="bg-white rounded-xl p-4 mb-6 border border-gray-200 shadow-sm">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" id="tanggal"
                        value="{{ $tanggal ?? '' }}"
                        class="w-full border-gray-300 rounded-lg px-3 py-2 text-gray-700 
                               focus:ring focus:ring-blue-200 focus:border-blue-400 transition">
                </div>
                    ...
                    @forelse ($tabungans as $item)
                        <tr class="border-t hover:bg-gray-50">
                            <td class="px-4 py-2 whitespace-nowrap">
                                {{ $loop->iteration + ($tabungans->currentPage() - 1) * $tabungans->perPage() }}
                            </td>
