    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <div>
            ...
            <x-text-input id="current_password" name="current_password" type="password"
                ...
                placeholder="Masukkan password saat ini" autocomplete="current-password" aria-invalid="{{ $errors->updatePassword->has('current_password') ? 'true' : 'false' }}" />
        ...
        <div>
            ...
            <x-text-input id="password" name="password" type="password"
                class="mt-1 block w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                placeholder="Minimal 8 karakter" autocomplete="new-password" aria-invalid="{{ $errors->updatePassword->has('password') ? 'true' : 'false' }}" />
            <p class="text-xs text-gray-500 mt-1">Gunakan kombinasi huruf besar, kecil, angka, dan simbol untuk keamanan lebih baik.</p>
        ...
        <div>
            ...
            <x-text-input id="password_confirmation" name="password_confirmation" type="password"
                class="mt-1 block w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                placeholder="Ulangi password baru" autocomplete="new-password" aria-invalid="{{ $errors->updatePassword->has('password_confirmation') ? 'true' : 'false' }}" />
