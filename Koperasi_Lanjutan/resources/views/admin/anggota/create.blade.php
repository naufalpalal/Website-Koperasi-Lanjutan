        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.anggota.index') }}" class="btn btn-warning btn-sm">Kembali</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.anggota.store') }}" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat_rumah') is-invalid @enderror" id="alamat_rumah" name="alamat_rumah" rows="3">{{ old('alamat_rumah') }}</textarea>
                                    @error('alamat_rumah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="{{ route('admin.anggota.index') }}" class="btn btn-danger px-4">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
