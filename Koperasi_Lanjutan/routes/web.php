...
Route::middleware(['auth:web'])->get('/dokumen/lihat/{userId}/{jenis}', [FileDokumenController::class, 'lihatDokumen'])
    ->name('dokumen.lihat.user');

Route::middleware(['auth:pengurus'])->get('/pengurus/dokumen/lihat/{userId}/{jenis}', [FileDokumenController::class, 'lihatDokumen'])
